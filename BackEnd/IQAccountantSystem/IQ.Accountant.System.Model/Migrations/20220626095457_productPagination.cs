...
{
    public partial class productPagination : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            string storedProcedureCode =
            "CREATE PROCEDURE dbo.GET_PRODUCT  @PageNo INT," +
            ...
            "From[PRODUCT]) t Where t.RowNum Between" + Environment.NewLine +
        ...
        {
            migrationBuilder.Sql("DROP PROC dbo.GET_PRODUCT");
        }
    }
}
